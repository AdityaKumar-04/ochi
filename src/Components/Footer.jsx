        ...
        <div className='w-full h-screen bg-zinc-800 p-20 flex'>
            <div className='w-1/2 h-full flex flex-col justify-between  '>
                <div className=''>
                    ...
                    <h1 className='text-[8vw] font-semibold uppercase leading-none -mb-6 '>OPANING</h1>
                </div>
            ...
            <div className='w-1/2'>
                <h1 className='text-[5vw] font-semibold uppercase leading-none -mb-6'>PRESENTATIONS</h1>
                <div className='mt-10'>
                    {['facebook', 'instagram', 'twitter'].map((item, index) => {
                        return (
                            <a href='#' className='text-xl font-serif block'>{item}</a>
                        )
                    })}
                </div>
            </div>
